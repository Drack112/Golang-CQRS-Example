...
var file_internal_services_product_service_product_grpc_client_protos_identity_service_proto_goTypes = []any{
...
func file_internal_services_product_service_product_grpc_client_protos_identity_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_services_product_service_product_grpc_client_protos_identity_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_services_product_service_product_grpc_client_protos_identity_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internal_services_product_service_product_grpc_client_protos_identity_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
